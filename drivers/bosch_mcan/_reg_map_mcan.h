...
#define _CANARD_MCAN_U_(x) x ## U    /**< C code: Unsigned integer literal constant value */
#define _CANARD_MCAN_L_(x) x ## L    /**< C code: Long integer literal constant value */
#define _CANARD_MCAN_UL_(x) x ## UL  /**< C code: Unsigned Long integer literal constant value */

/* CANARD_MCAN_CREL - Core Release Register - 0x00 */
#define CANARD_MCAN_CREL_DAY_Pos                   0                                               /* (CANARD_MCAN_CREL) Timestamp Day Position */                                         
#define CANARD_MCAN_CREL_DAY_Msk                   (_CANARD_MCAN_U_(0xFF) << CANARD_MCAN_CREL_DAY_Pos)               /* (CANARD_MCAN_CREL) Timestamp Day Mask */
...
#define CANARD_MCAN_CREL_MON_Msk                   (_CANARD_MCAN_U_(0xFF) << CANARD_MCAN_CREL_MON_Pos)               /* (CANARD_MCAN_CREL) Timestamp Month Mask */
...
#define CANARD_MCAN_CREL_YEAR_Msk                  (_CANARD_MCAN_U_(0xF) << CANARD_MCAN_CREL_YEAR_Pos)               /* (CANARD_MCAN_CREL) Timestamp Year Mask */
...
#define CANARD_MCAN_CREL_SUBSTEP_Msk               (_CANARD_MCAN_U_(0xF) << CANARD_MCAN_CREL_SUBSTEP_Pos)            /* (CANARD_MCAN_CREL) Sub-step of Core Release Mask */
...
#define CANARD_MCAN_CREL_STEP_Msk                  (_CANARD_MCAN_U_(0xF) << CANARD_MCAN_CREL_STEP_Pos)               /* (CANARD_MCAN_CREL) Step of Core Release Mask */
...
#define CANARD_MCAN_CREL_REL_Msk                   (_CANARD_MCAN_U_(0xF) << CANARD_MCAN_CREL_REL_Pos)                /* (CANARD_MCAN_CREL) Core Release Mask */
...
#define CANARD_MCAN_DBTP_DSJW_Msk                  (_CANARD_MCAN_U_(0x7) << CANARD_MCAN_DBTP_DSJW_Pos)								/* Data (Re) Synchronization Jump Width Mask */
...
#define CANARD_MCAN_DBTP_DTSEG2_Msk                (_CANARD_MCAN_U_(0xF) << CANARD_MCAN_DBTP_DTSEG2_Pos)								/* Data Time Segment After Sample Point Mask */
...
#define CANARD_MCAN_DBTP_DTSEG1_Msk                (_CANARD_MCAN_U_(0x1F) << CANARD_MCAN_DBTP_DTSEG1_Pos)								/* Data Time Segment Before Sample Point Mask */
...
#define CANARD_MCAN_DBTP_DBRP_Msk                  (_CANARD_MCAN_U_(0x1F) << CANARD_MCAN_DBTP_DBRP_Pos)								/* Fast Baud Rate Prescaler Mask */
...
#define CANARD_MCAN_DBTP_TDC_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_DBTP_TDC_Pos)									/* Transceiver Delay Compensation Mask */
...
#define CANARD_MCAN_CCCR_INIT_Msk                  (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_CCCR_INIT_Pos)               /* (CANARD_MCAN_CCCR) Initialization Mask */
...
#define CANARD_MCAN_CCCR_CCE_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_CCCR_CCE_Pos)                /* (CANARD_MCAN_CCCR) Configuration Change Enable Mask */
...
#define CANARD_MCAN_CCCR_ASM_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_CCCR_ASM_Pos)                /* (CANARD_MCAN_CCCR) Restricted Operation Mode Mask */
...
#define CANARD_MCAN_CCCR_CSA_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_CCCR_CSA_Pos)                /* (CANARD_MCAN_CCCR) Clock Stop Acknowledge Mask */
...
#define CANARD_MCAN_CCCR_CSR_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_CCCR_CSR_Pos)                /* (CANARD_MCAN_CCCR) Clock Stop Request Mask */
...
#define CANARD_MCAN_CCCR_MON_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_CCCR_MON_Pos)                /* (CANARD_MCAN_CCCR) Bus Monitoring Mode Mask */
...
#define CANARD_MCAN_CCCR_DAR_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_CCCR_DAR_Pos)                /* (CANARD_MCAN_CCCR) Disable Automatic Retransmission Mask */
...
#define CANARD_MCAN_CCCR_TEST_Msk                  (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_CCCR_TEST_Pos)               /* (CANARD_MCAN_CCCR) Test Mode Enable Mask */
...
#define CANARD_MCAN_CCCR_FDOE_Msk                   (_CANARD_MCAN_U_(0x3) << CANARD_MCAN_CCCR_FDOE_Pos)                /* (CANARD_MCAN_CCCR) FD Operation Enable Mask */
...
#define CANARD_MCAN_CCCR_BRSE_Msk                   (_CANARD_MCAN_U_(0x3) << CANARD_MCAN_CCCR_BRSE_Pos)                /* (CANARD_MCAN_CCCR) Bit Rate Switch Enable Mask */
...
#define CANARD_MCAN_CCCR_PXHD_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_CCCR_FDO_Pos)                /* (CANARD_MCAN_CCCR) Protocol Exception Handling Disable Mask */
...
#define CANARD_MCAN_CCCR_EFBI_Msk                  (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_CCCR_FDBS_Pos)               /* (CANARD_MCAN_CCCR) Edge Filtering during Bus Integration Mask */
...
#define CANARD_MCAN_CCCR_TXP_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_CCCR_TXP_Pos)                /* (CANARD_MCAN_CCCR) Transmit Pause Mask */
...
#define CANARD_MCAN_CCCR_NISO_Msk                  (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_CCCR_NISO_Pos)               /* (CANARD_MCAN_CCCR) Non-ISO Operation Mask */
...
#define CANARD_MCAN_NBTP_NTSEG2_Msk                  (_CANARD_MCAN_U_(0x7F) << CANARD_MCAN_NBTP_NTSEG2_Pos)							/* Time Segment After Sample Point Mask */
...
#define CANARD_MCAN_NBTP_NTSEG1_Msk                  (_CANARD_MCAN_U_(0xFF) << CANARD_MCAN_NBTP_NTSEG1_Pos)							/* Time Segment Before Sample Point Mask */
...
#define CANARD_MCAN_NBTP_NBRP_Msk                    (_CANARD_MCAN_U_(0x1FF) << CANARD_MCAN_NBTP_NBRP_Pos)							/* Baud Rate Prescaler Mask */
...
#define CANARD_MCAN_NBTP_NSJW_Msk                    (_CANARD_MCAN_U_(0x7F) << CANARD_MCAN_NBTP_NSJW_Pos)								/* (Re) Synchronization Jump Width Mask */
...
#define CANARD_MCAN_TDCR_TDCF_Msk                  (_CANARD_MCAN_U_(0x7F) << CANARD_MCAN_TDCR_TDCF_Pos)                               /* (CANARD_MCAN_TDCR) Transmitter Delay Compensation Filter Mask */
...
#define CANARD_MCAN_TDCR_TDCO_Msk                  (_CANARD_MCAN_U_(0x7F) << CANARD_MCAN_TDCR_TDCO_Pos)                               /* (CANARD_MCAN_TDCR) Transmitter Delay Compensation Offset Mask */
...
#define CANARD_MCAN_IR_RF0N_Msk                    (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IR_RF0N_Pos)                 /* (CANARD_MCAN_IR) Receive FIFO 0 New Message Mask */
...
#define CANARD_MCAN_IR_RF0W_Msk                    (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IR_RF0W_Pos)                 /* (CANARD_MCAN_IR) Receive FIFO 0 Watermark Reached Mask */
...
#define CANARD_MCAN_IR_RF0F_Msk                    (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IR_RF0F_Pos)                 /* (CANARD_MCAN_IR) Receive FIFO 0 Full Mask */
...
#define CANARD_MCAN_IR_RF0L_Msk                    (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IR_RF0L_Pos)                 /* (CANARD_MCAN_IR) Receive FIFO 0 Message Lost Mask */
...
#define CANARD_MCAN_IR_RF1N_Msk                    (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IR_RF1N_Pos)                 /* (CANARD_MCAN_IR) Receive FIFO 1 New Message Mask */
...
#define CANARD_MCAN_IR_RF1W_Msk                    (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IR_RF1W_Pos)                 /* (CANARD_MCAN_IR) Receive FIFO 1 Watermark Reached Mask */
...
#define CANARD_MCAN_IR_RF1F_Msk                    (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IR_RF1F_Pos)                 /* (CANARD_MCAN_IR) Receive FIFO 1 Full Mask */
...
#define CANARD_MCAN_IR_RF1L_Msk                    (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IR_RF1L_Pos)                 /* (CANARD_MCAN_IR) Receive FIFO 1 Message Lost Mask */
...
#define CANARD_MCAN_IR_HPM_Msk                     (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IR_HPM_Pos)                  /* (CANARD_MCAN_IR) High Priority Message Mask */
...
#define CANARD_MCAN_IR_TC_Msk                      (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IR_TC_Pos)                   /* (CANARD_MCAN_IR) Transmission Completed Mask */
...
#define CANARD_MCAN_IR_TCF_Msk                     (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IR_TCF_Pos)                  /* (CANARD_MCAN_IR) Transmission Cancellation Finished Mask */
...
#define CANARD_MCAN_IR_TFE_Msk                     (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IR_TFE_Pos)                  /* (CANARD_MCAN_IR) Tx FIFO Empty Mask */
...
#define CANARD_MCAN_IR_TEFN_Msk                    (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IR_TEFN_Pos)                 /* (CANARD_MCAN_IR) Tx Event FIFO New Entry Mask */
...
#define CANARD_MCAN_IR_TEFW_Msk                    (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IR_TEFW_Pos)                 /* (CANARD_MCAN_IR) Tx Event FIFO Watermark Reached Mask */
...
#define CANARD_MCAN_IR_TEFF_Msk                    (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IR_TEFF_Pos)                 /* (CANARD_MCAN_IR) Tx Event FIFO Full Mask */
...
#define CANARD_MCAN_IR_TEFL_Msk                    (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IR_TEFL_Pos)                 /* (CANARD_MCAN_IR) Tx Event FIFO Element Lost Mask */
...
#define CANARD_MCAN_IR_TSW_Msk                     (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IR_TSW_Pos)                  /* (CANARD_MCAN_IR) Timestamp Wraparound Mask */
...
#define CANARD_MCAN_IR_MRAF_Msk                    (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IR_MRAF_Pos)                 /* (CANARD_MCAN_IR) Message RAM Access Failure Mask */
...
#define CANARD_MCAN_IR_TOO_Msk                     (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IR_TOO_Pos)                  /* (CANARD_MCAN_IR) Timeout Occurred Mask */
...
#define CANARD_MCAN_IR_DRX_Msk                     (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IR_DRX_Pos)                  /* (CANARD_MCAN_IR) Message stored to Dedicated Receive Buffer Mask */
...
#define CANARD_MCAN_IR_BEC_Msk                     (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IR_BEC_Pos)                  /* (CANARD_MCAN_IR) Bit Error Corrected Mask */
...
#define CANARD_MCAN_IR_BEU_Msk                     (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IR_BEU_Pos)                  /* (CANARD_MCAN_IR) Bit Error Uncorrected Mask */
...
#define CANARD_MCAN_IR_ELO_Msk                     (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IR_ELO_Pos)                  /* (CANARD_MCAN_IR) Error Logging Overflow Mask */
...
#define CANARD_MCAN_IR_EP_Msk                      (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IR_EP_Pos)                   /* (CANARD_MCAN_IR) Error Passive Mask */
...
#define CANARD_MCAN_IR_EW_Msk                      (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IR_EW_Pos)                   /* (CANARD_MCAN_IR) Warning Status Mask */
...
#define CANARD_MCAN_IR_BO_Msk                      (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IR_BO_Pos)                   /* (CANARD_MCAN_IR) Bus_Off Status Mask */
...
#define CANARD_MCAN_IR_WDI_Msk                     (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IR_WDI_Pos)                  /* (CANARD_MCAN_IR) Watchdog Interrupt Mask */
...
#define CANARD_MCAN_IR_PEA_Msk                     (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IR_PEA_Pos)                  /* (CANARD_MCAN_IR) Protocol Error in Arbitration Phase Mask */
...
#define CANARD_MCAN_IR_PED_Msk                     (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IR_PED_Pos)                  /* (CANARD_MCAN_IR) Protocol Error in Data Phase Mask */
...
#define CANARD_MCAN_IR_ARA_Msk                     (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IR_ARA_Pos)                  /* (CANARD_MCAN_IR) Access to Reserved Address Mask */
...
#define CANARD_MCAN_IE_RF0NE_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IE_RF0NE_Pos)                /* (CANARD_MCAN_IE) Receive FIFO 0 New Message Interrupt Enable Mask */
...
#define CANARD_MCAN_IE_RF0WE_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IE_RF0WE_Pos)                /* (CANARD_MCAN_IE) Receive FIFO 0 Watermark Reached Interrupt Enable Mask */
...
#define CANARD_MCAN_IE_RF0FE_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IE_RF0FE_Pos)                /* (CANARD_MCAN_IE) Receive FIFO 0 Full Interrupt Enable Mask */
...
#define CANARD_MCAN_IE_RF0LE_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IE_RF0LE_Pos)                /* (CANARD_MCAN_IE) Receive FIFO 0 Message Lost Interrupt Enable Mask */
...
#define CANARD_MCAN_IE_RF1NE_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IE_RF1NE_Pos)                /* (CANARD_MCAN_IE) Receive FIFO 1 New Message Interrupt Enable Mask */
...
#define CANARD_MCAN_IE_RF1WE_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IE_RF1WE_Pos)                /* (CANARD_MCAN_IE) Receive FIFO 1 Watermark Reached Interrupt Enable Mask */
...
#define CANARD_MCAN_IE_RF1FE_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IE_RF1FE_Pos)                /* (CANARD_MCAN_IE) Receive FIFO 1 Full Interrupt Enable Mask */
...
#define CANARD_MCAN_IE_RF1LE_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IE_RF1LE_Pos)                /* (CANARD_MCAN_IE) Receive FIFO 1 Message Lost Interrupt Enable Mask */
...
#define CANARD_MCAN_IE_HPME_Msk                    (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IE_HPME_Pos)                 /* (CANARD_MCAN_IE) High Priority Message Interrupt Enable Mask */
...
#define CANARD_MCAN_IE_TCE_Msk                     (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IE_TCE_Pos)                  /* (CANARD_MCAN_IE) Transmission Completed Interrupt Enable Mask */
...
#define CANARD_MCAN_IE_TCFE_Msk                    (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IE_TCFE_Pos)                 /* (CANARD_MCAN_IE) Transmission Cancellation Finished Interrupt Enable Mask */
...
#define CANARD_MCAN_IE_TFEE_Msk                    (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IE_TFEE_Pos)                 /* (CANARD_MCAN_IE) Tx FIFO Empty Interrupt Enable Mask */
...
#define CANARD_MCAN_IE_TEFNE_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IE_TEFNE_Pos)                /* (CANARD_MCAN_IE) Tx Event FIFO New Entry Interrupt Enable Mask */
...
#define CANARD_MCAN_IE_TEFWE_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IE_TEFWE_Pos)                /* (CANARD_MCAN_IE) Tx Event FIFO Watermark Reached Interrupt Enable Mask */
...
#define CANARD_MCAN_IE_TEFFE_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IE_TEFFE_Pos)                /* (CANARD_MCAN_IE) Tx Event FIFO Full Interrupt Enable Mask */
...
#define CANARD_MCAN_IE_TEFLE_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IE_TEFLE_Pos)                /* (CANARD_MCAN_IE) Tx Event FIFO Event Lost Interrupt Enable Mask */
...
#define CANARD_MCAN_IE_TSWE_Msk                    (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IE_TSWE_Pos)                 /* (CANARD_MCAN_IE) Timestamp Wraparound Interrupt Enable Mask */
...
#define CANARD_MCAN_IE_MRAFE_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IE_MRAFE_Pos)                /* (CANARD_MCAN_IE) Message RAM Access Failure Interrupt Enable Mask */
...
#define CANARD_MCAN_IE_TOOE_Msk                    (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IE_TOOE_Pos)                 /* (CANARD_MCAN_IE) Timeout Occurred Interrupt Enable Mask */
...
#define CANARD_MCAN_IE_DRXE_Msk                    (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IE_DRXE_Pos)                 /* (CANARD_MCAN_IE) Message stored to Dedicated Receive Buffer Interrupt Enable Mask */
...
#define CANARD_MCAN_IE_BECE_Msk                    (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IE_BECE_Pos)                 /* (CANARD_MCAN_IE) Bit Error Corrected Interrupt Enable Mask */
...
#define CANARD_MCAN_IE_BEUE_Msk                    (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IE_BEUE_Pos)                 /* (CANARD_MCAN_IE) Bit Error Uncorrected Interrupt Enable Mask */
...
#define CANARD_MCAN_IE_ELOE_Msk                    (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IE_ELOE_Pos)                 /* (CANARD_MCAN_IE) Error Logging Overflow Interrupt Enable Mask */
...
#define CANARD_MCAN_IE_EPE_Msk                     (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IE_EPE_Pos)                  /* (CANARD_MCAN_IE) Error Passive Interrupt Enable Mask */
...
#define CANARD_MCAN_IE_EWE_Msk                     (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IE_EWE_Pos)                  /* (CANARD_MCAN_IE) Warning Status Interrupt Enable Mask */
...
#define CANARD_MCAN_IE_BOE_Msk                     (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IE_BOE_Pos)                  /* (CANARD_MCAN_IE) Bus_Off Status Interrupt Enable Mask */
...
#define CANARD_MCAN_IE_WDIE_Msk                    (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IE_WDIE_Pos)                 /* (CANARD_MCAN_IE) Watchdog Interrupt Enable Mask */
...
#define CANARD_MCAN_IE_CRCEE_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IE_CRCEE_Pos)                /* (CANARD_MCAN_IE) CRC Error Interrupt Enable Mask */
...
#define CANARD_MCAN_IE_PEDE_Msk                    (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IE_PEDE_Pos)                 /* (CANARD_MCAN_IE) Protocol Error in Data Phase Enable Mask */
...
#define CANARD_MCAN_IE_ARAE_Msk                    (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_IE_ARAE_Pos)                 /* (CANARD_MCAN_IE) Access to Reserved Address Enable Mask */
...
#define CANARD_MCAN_ILS_RF0NL_Msk                  (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_ILS_RF0NL_Pos)               /* (CANARD_MCAN_ILS) Receive FIFO 0 New Message Interrupt Line Mask */
...
#define CANARD_MCAN_ILS_RF0WL_Msk                  (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_ILS_RF0WL_Pos)               /* (CANARD_MCAN_ILS) Receive FIFO 0 Watermark Reached Interrupt Line Mask */
...
#define CANARD_MCAN_ILS_RF0FL_Msk                  (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_ILS_RF0FL_Pos)               /* (CANARD_MCAN_ILS) Receive FIFO 0 Full Interrupt Line Mask */
...
#define CANARD_MCAN_ILS_RF0LL_Msk                  (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_ILS_RF0LL_Pos)               /* (CANARD_MCAN_ILS) Receive FIFO 0 Message Lost Interrupt Line Mask */
...
#define CANARD_MCAN_ILS_RF1NL_Msk                  (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_ILS_RF1NL_Pos)               /* (CANARD_MCAN_ILS) Receive FIFO 1 New Message Interrupt Line Mask */
...
#define CANARD_MCAN_ILS_RF1WL_Msk                  (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_ILS_RF1WL_Pos)               /* (CANARD_MCAN_ILS) Receive FIFO 1 Watermark Reached Interrupt Line Mask */
...
#define CANARD_MCAN_ILS_RF1FL_Msk                  (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_ILS_RF1FL_Pos)               /* (CANARD_MCAN_ILS) Receive FIFO 1 Full Interrupt Line Mask */
...
#define CANARD_MCAN_ILS_RF1LL_Msk                  (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_ILS_RF1LL_Pos)               /* (CANARD_MCAN_ILS) Receive FIFO 1 Message Lost Interrupt Line Mask */
...
#define CANARD_MCAN_ILS_HPML_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_ILS_HPML_Pos)                /* (CANARD_MCAN_ILS) High Priority Message Interrupt Line Mask */
...
#define CANARD_MCAN_ILS_TCL_Msk                    (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_ILS_TCL_Pos)                 /* (CANARD_MCAN_ILS) Transmission Completed Interrupt Line Mask */
...
#define CANARD_MCAN_ILS_TCFL_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_ILS_TCFL_Pos)                /* (CANARD_MCAN_ILS) Transmission Cancellation Finished Interrupt Line Mask */
...
#define CANARD_MCAN_ILS_TFEL_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_ILS_TFEL_Pos)                /* (CANARD_MCAN_ILS) Tx FIFO Empty Interrupt Line Mask */
...
#define CANARD_MCAN_ILS_TEFNL_Msk                  (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_ILS_TEFNL_Pos)               /* (CANARD_MCAN_ILS) Tx Event FIFO New Entry Interrupt Line Mask */
...
#define CANARD_MCAN_ILS_TEFWL_Msk                  (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_ILS_TEFWL_Pos)               /* (CANARD_MCAN_ILS) Tx Event FIFO Watermark Reached Interrupt Line Mask */
...
#define CANARD_MCAN_ILS_TEFFL_Msk                  (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_ILS_TEFFL_Pos)               /* (CANARD_MCAN_ILS) Tx Event FIFO Full Interrupt Line Mask */
...
#define CANARD_MCAN_ILS_TEFLL_Msk                  (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_ILS_TEFLL_Pos)               /* (CANARD_MCAN_ILS) Tx Event FIFO Event Lost Interrupt Line Mask */
...
#define CANARD_MCAN_ILS_TSWL_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_ILS_TSWL_Pos)                /* (CANARD_MCAN_ILS) Timestamp Wraparound Interrupt Line Mask */
...
#define CANARD_MCAN_ILS_MRAFL_Msk                  (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_ILS_MRAFL_Pos)               /* (CANARD_MCAN_ILS) Message RAM Access Failure Interrupt Line Mask */
...
#define CANARD_MCAN_ILS_TOOL_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_ILS_TOOL_Pos)                /* (CANARD_MCAN_ILS) Timeout Occurred Interrupt Line Mask */
...
#define CANARD_MCAN_ILS_DRXL_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_ILS_DRXL_Pos)                /* (CANARD_MCAN_ILS) Message stored to Dedicated Receive Buffer Interrupt Line Mask */
...
#define CANARD_MCAN_ILS_BECL_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_ILS_BECL_Pos)                /* (CANARD_MCAN_ILS) Bit Error Corrected Interrupt Line Mask */
...
#define CANARD_MCAN_ILS_BEUL_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_ILS_BEUL_Pos)                /* (CANARD_MCAN_ILS) Bit Error Uncorrected Interrupt Line Mask */
...
#define CANARD_MCAN_ILS_ELOL_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_ILS_ELOL_Pos)                /* (CANARD_MCAN_ILS) Error Logging Overflow Interrupt Line Mask */
...
#define CANARD_MCAN_ILS_EPL_Msk                    (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_ILS_EPL_Pos)                 /* (CANARD_MCAN_ILS) Error Passive Interrupt Line Mask */
...
#define CANARD_MCAN_ILS_EWL_Msk                    (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_ILS_EWL_Pos)                 /* (CANARD_MCAN_ILS) Warning Status Interrupt Line Mask */
...
#define CANARD_MCAN_ILS_BOL_Msk                    (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_ILS_BOL_Pos)                 /* (CANARD_MCAN_ILS) Bus_Off Status Interrupt Line Mask */
...
#define CANARD_MCAN_ILS_WDIL_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_ILS_WDIL_Pos)                /* (CANARD_MCAN_ILS) Watchdog Interrupt Line Mask */
...
#define CANARD_MCAN_ILS_CRCEL_Msk                  (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_ILS_CRCEL_Pos)               /* (CANARD_MCAN_ILS) CRC Error Interrupt Line Mask */
...
#define CANARD_MCAN_ILS_PEDL_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_ILS_PEDL_Pos)                /* (CANARD_MCAN_ILS) Protocol Error in Data Phase Line Mask */
...
#define CANARD_MCAN_ILS_ARAL_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_ILS_ARAL_Pos)                /* (CANARD_MCAN_ILS) Access to Reserved Address Line Mask */
...
#define CANARD_MCAN_ILE_EINT0_Msk                   (_CANARD_MCAN_U_(0x3) << CANARD_MCAN_ILE_EINT0_Pos)               /* (CANARD_MCAN_ILE) Enable Interrupt Line 0 Mask */
...
#define CANARD_MCAN_ILE_EINT1_Msk                   (_CANARD_MCAN_U_(0x3) << CANARD_MCAN_ILE_EINT1_Pos)               /* (CANARD_MCAN_ILE) Enable Interrupt Line 1 Mask */
...
#define CANARD_MCAN_GFC_RRFE_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_GFC_RRFE_Pos)                         /* (CANARD_MCAN_GFC) Reject Remote Frames Extended Mask */
...
#define CANARD_MCAN_GFC_RRFS_Msk                   (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_GFC_RRFS_Pos)                         /* (CANARD_MCAN_GFC) Reject Remote Frames Standard Mask */
...
#define CANARD_MCAN_GFC_ANFE_Msk                   (_CANARD_MCAN_U_(0x3) << CANARD_MCAN_GFC_ANFE_Pos)                         /* (CANARD_MCAN_GFC) Accept Non-matching Frames Extended Mask */
...
#define CANARD_MCAN_GFC_ANFS_Msk                   (_CANARD_MCAN_U_(0x3) << CANARD_MCAN_GFC_ANFS_Pos)                         /* (CANARD_MCAN_GFC) Accept Non-matching Frames Standard Mask */
...
#define CANARD_MCAN_SIDFC_FLSSA_Msk                (_CANARD_MCAN_U_(0x3FFF) << CANARD_MCAN_SIDFC_FLSSA_Pos)                       /* (CANARD_MCAN_SIDFC) Filter List Standard Start Address Mask */
...
#define CANARD_MCAN_SIDFC_LSS_Msk                  (_CANARD_MCAN_U_(0xFF) << CANARD_MCAN_SIDFC_LSS_Pos)                           /* (CANARD_MCAN_SIDFC) List Size Standard Mask */
...
#define CANARD_MCAN_XIDFC_FLESA_Msk                (_CANARD_MCAN_U_(0x3FFF) << CANARD_MCAN_XIDFC_FLESA_Pos)                       /* (CANARD_MCAN_XIDFC) Filter List Extended Start Address Mask */
...
#define CANARD_MCAN_XIDFC_LSE_Msk                  (_CANARD_MCAN_U_(0x7F) << CANARD_MCAN_XIDFC_LSE_Pos)                           /* (CANARD_MCAN_XIDFC) List Size Extended Mask */
...
#define CANARD_MCAN_XIDAM_EIDM_Msk                 (_CANARD_MCAN_U_(0x1FFFFFFF) << CANARD_MCAN_XIDAM_EIDM_Pos)                    /* (CANARD_MCAN_XIDAM) Extended ID Mask Mask */
...
#define CANARD_MCAN_RXF0C_F0SA_Msk                 (_CANARD_MCAN_U_(0x3FFF) << CANARD_MCAN_RXF0C_F0SA_Pos)                        /* (CANARD_MCAN_RXF0C) Receive FIFO 0 Start Address Mask */
...
#define CANARD_MCAN_RXF0C_F0S_Msk                  (_CANARD_MCAN_U_(0x7F) << CANARD_MCAN_RXF0C_F0S_Pos)                           /* (CANARD_MCAN_RXF0C) Receive FIFO 0 Start Address Mask */
...
#define CANARD_MCAN_RXF0C_F0WM_Msk                 (_CANARD_MCAN_U_(0x7F) << CANARD_MCAN_RXF0C_F0WM_Pos)                          /* (CANARD_MCAN_RXF0C) Receive FIFO 0 Watermark Mask */
...
#define CANARD_MCAN_RXF0C_F0OM_Msk                 (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_RXF0C_F0OM_Pos)                           /* (CANARD_MCAN_RXF0C) FIFO 0 Operation Mode Mask */
...
#define CANARD_MCAN_RXF0S_F0FL_Msk                 (_CANARD_MCAN_U_(0x7F) << CANARD_MCAN_RXF0S_F0FL_Pos)                          /* (CANARD_MCAN_RXF0S) Receive FIFO 0 Fill Level Mask */
...
#define CANARD_MCAN_RXF0S_F0GI_Msk                 (_CANARD_MCAN_U_(0x3F) << CANARD_MCAN_RXF0S_F0GI_Pos)                          /* (CANARD_MCAN_RXF0S) Receive FIFO 0 Get Index Mask */
...
#define CANARD_MCAN_RXF0S_F0PI_Msk                 (_CANARD_MCAN_U_(0x3F) << CANARD_MCAN_RXF0S_F0PI_Pos)                          /* (CANARD_MCAN_RXF0S) Receive FIFO 0 Put Index Mask */
...
#define CANARD_MCAN_RXF0S_F0F_Msk                  (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_RXF0S_F0F_Pos)                            /* (CANARD_MCAN_RXF0S) Receive FIFO 0 Fill Level Mask */
...
#define CANARD_MCAN_RXF0S_RF0L_Msk                 (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_RXF0S_RF0L_Pos)                           /* (CANARD_MCAN_RXF0S) Receive FIFO 0 Message Lost Mask */
...
#define CANARD_MCAN_RXF0A_F0AI_Msk                 (_CANARD_MCAN_U_(0x3F) << CANARD_MCAN_RXF0A_F0AI_Pos)                          /* (CANARD_MCAN_RXF0A) Receive FIFO 0 Acknowledge Index Mask */
...
#define CANARD_MCAN_RXBC_RBSA_Msk                  (_CANARD_MCAN_U_(0x3FFF) << CANARD_MCAN_RXBC_RBSA_Pos)                         /* (CANARD_MCAN_RXBC) Receive Buffer Start Address Mask */
...
#define CANARD_MCAN_RXF1C_F1SA_Msk                 (_CANARD_MCAN_U_(0x3FFF) << CANARD_MCAN_RXF1C_F1SA_Pos)                        /* (CANARD_MCAN_RXF1C) Receive FIFO 1 Start Address Mask */
...
#define CANARD_MCAN_RXF1C_F1S_Msk                  (_CANARD_MCAN_U_(0x7F) << CANARD_MCAN_RXF1C_F1S_Pos)                           /* (CANARD_MCAN_RXF1C) Receive FIFO 1 Start Address Mask */
...
#define CANARD_MCAN_RXF1C_F1WM_Msk                 (_CANARD_MCAN_U_(0x7F) << CANARD_MCAN_RXF1C_F1WM_Pos)                          /* (CANARD_MCAN_RXF1C) Receive FIFO 1 Watermark Mask */
...
#define CANARD_MCAN_RXF1S_F1FL_Msk                 (_CANARD_MCAN_U_(0x7F) << CANARD_MCAN_RXF1S_F1FL_Pos)                          /* (CANARD_MCAN_RXF1S) Receive FIFO 1 Fill Level Mask */
...
#define CANARD_MCAN_RXF1S_F1GI_Msk                 (_CANARD_MCAN_U_(0x3F) << CANARD_MCAN_RXF1S_F1GI_Pos)                          /* (CANARD_MCAN_RXF1S) Receive FIFO 1 Get Index Mask */
...
#define CANARD_MCAN_RXF1S_F1PI_Msk                 (_CANARD_MCAN_U_(0x3F) << CANARD_MCAN_RXF1S_F1PI_Pos)                          /* (CANARD_MCAN_RXF1S) Receive FIFO 1 Put Index Mask */
...
#define CANARD_MCAN_RXF1S_F1F_Msk                  (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_RXF1S_F1F_Pos)                            /* (CANARD_MCAN_RXF1S) Receive FIFO 1 Fill Level Mask */
...
#define CANARD_MCAN_RXF1S_RF1L_Msk                 (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_RXF1S_RF1L_Pos)                           /* (CANARD_MCAN_RXF1S) Receive FIFO 1 Message Lost Mask */
...
#define CANARD_MCAN_RXF1S_DMS_Msk                  (_CANARD_MCAN_U_(0x3) << CANARD_MCAN_RXF1S_DMS_Pos)                            /* (CANARD_MCAN_RXF1S) Debug Message Status Mask */
...
#define CANARD_MCAN_RXF1A_F1AI_Msk                 (_CANARD_MCAN_U_(0x3F) << CANARD_MCAN_RXF1A_F1AI_Pos)                          /* (CANARD_MCAN_RXF1A) Receive FIFO 1 Acknowledge Index Mask */
...
#define CANARD_MCAN_RXESC_F0DS_Msk                 (_CANARD_MCAN_U_(0x7) << CANARD_MCAN_RXESC_F0DS_Pos)                           /* (CANARD_MCAN_RXESC) Receive FIFO 0 Data Field Size Mask */
...
#define CANARD_MCAN_RXESC_F1DS_Msk                 (_CANARD_MCAN_U_(0x7) << CANARD_MCAN_RXESC_F1DS_Pos)                           /* (CANARD_MCAN_RXESC) Receive FIFO 1 Data Field Size Mask */
...
#define CANARD_MCAN_RXESC_RBDS_Msk                 (_CANARD_MCAN_U_(0x7) << CANARD_MCAN_RXESC_RBDS_Pos)                           /* (CANARD_MCAN_RXESC) Receive Buffer Data Field Size Mask */
...
#define CANARD_MCAN_TXBC_TBSA_Msk                  (_CANARD_MCAN_U_(0x3FFF) << CANARD_MCAN_TXBC_TBSA_Pos)                         /* (CANARD_MCAN_TXBC) Tx Buffers Start Address Mask */
...
#define CANARD_MCAN_TXBC_NDTB_Msk                  (_CANARD_MCAN_U_(0x3F) << CANARD_MCAN_TXBC_NDTB_Pos)                           /* (CANARD_MCAN_TXBC) Number of Dedicated Transmit Buffers Mask */
...
#define CANARD_MCAN_TXBC_TFQS_Msk                  (_CANARD_MCAN_U_(0x3F) << CANARD_MCAN_TXBC_TFQS_Pos)                           /* (CANARD_MCAN_TXBC) Transmit FIFO/Queue Size Mask */
...
#define CANARD_MCAN_TXBC_TFQM_Msk                  (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_TXBC_TFQM_Pos)                            /* (CANARD_MCAN_TXBC) Tx FIFO/Queue Mode Mask */
...
#define CANARD_MCAN_TXFQS_TFFL_Msk                 (_CANARD_MCAN_U_(0x3F) << CANARD_MCAN_TXFQS_TFFL_Pos)                          /* (CANARD_MCAN_TXFQS) Tx FIFO Free Level Mask */
...
#define CANARD_MCAN_TXFQS_TFGI_Msk                 (_CANARD_MCAN_U_(0x1F) << CANARD_MCAN_TXFQS_TFGI_Pos)                          /* (CANARD_MCAN_TXFQS) Tx FIFO Get Index Mask */
...
#define CANARD_MCAN_TXFQS_TFQPI_Msk                (_CANARD_MCAN_U_(0x1F) << CANARD_MCAN_TXFQS_TFQPI_Pos)                         /* (CANARD_MCAN_TXFQS) Tx FIFO/Queue Put Index Mask */
...
#define CANARD_MCAN_TXFQS_TFQF_Msk                 (_CANARD_MCAN_U_(0x1) << CANARD_MCAN_TXFQS_TFQF_Pos)                           /* (CANARD_MCAN_TXFQS) Tx FIFO/Queue Full Mask */
...
#define CANARD_MCAN_TXESC_TBDS_Msk                 (_CANARD_MCAN_U_(0x7) << CANARD_MCAN_TXESC_TBDS_Pos)                           /* (CANARD_MCAN_TXESC) Tx Buffer Data Field Size Mask */
...
#define CANARD_MCAN_TXBRP_TRP_Msk                  (_CANARD_MCAN_U_(0xFFFFFFFF) << CANARD_MCAN_TXBRP_TRP_Pos)                     /* (CANARD_MCAN_TXBRP) Transmission Request Pending Mask */
...
#define CANARD_MCAN_TXBAR_AR_Msk                   (_CANARD_MCAN_U_(0xFFFFFFFF) << CANARD_MCAN_TXBAR_AR_Pos)                      /* (CANARD_MCAN_TXBAR) Add Request Mask */
...
#define CANARD_MCAN_TXBTIE_TIE_Msk                 (_CANARD_MCAN_U_(0xFFFFFFFF) << CANARD_MCAN_TXBTIE_TIE_Pos)                    /* (CANARD_MCAN_TXBTIE) Transmission Interrupt Enable Mask */
...
#define CANARD_MCAN_TXBCIE_CFIE_Msk                (_CANARD_MCAN_U_(0xFFFFFFFF) << CANARD_MCAN_TXBCIE_CFIE_Pos)                   /* (CANARD_MCAN_TXBCIE) Cancellation Finished Interrupt Enable Mask */
