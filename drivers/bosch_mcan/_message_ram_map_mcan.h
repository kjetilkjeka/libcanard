...
#define MCAN_MESSAGE_RX_BUFFER_R0_ID_Pos (0)
#define MCAN_MESSAGE_RX_BUFFER_R0_ID_Msk (0x1fffffffU << MCAN_MESSAGE_RX_BUFFER_R0_ID_Pos)
#define MCAN_MESSAGE_RX_BUFFER_R0_ID(value) ((value << MCAN_MESSAGE_RX_BUFFER_R0_ID_Pos) & MCAN_MESSAGE_RX_BUFFER_R0_ID_Msk)
